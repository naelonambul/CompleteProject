...
BEGIN_MESSAGE_MAP(CPPTServerDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_START, &CPPTServerDlg::OnBnClickedButtonStart)
	ON_BN_CLICKED(IDC_BUTTON_STOP, &CPPTServerDlg::OnBnClickedButtonStop)
END_MESSAGE_MAP()
...
void CPPTServerDlg::OnBnClickedButtonStart()
{
	// TODO: Add your control notification handler code here
	...
	{
		AfxMessageBox(_T("ERROR: Socket Create"));
		return; 
	}

	if(m_ListenSocket.Listen() == FALSE)
		AfxMessageBox(_T("ERROR: Listen Connected"));

}


void CPPTServerDlg::OnBnClickedButtonStop()
{
	// TODO: Add your control notification handler code here
	m_ListenSocket.CloseAll();
}
